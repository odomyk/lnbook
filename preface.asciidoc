...
* Bolatov, Umar (@bolatovumar)
* Boufnichel, Hatim (@boufni95)
* Bovi, Simone (@SimoneBovi)
* Imran Lorgat (@ImranLorgat)
* Last, Omega X. (@omega_github_id)
* Lima III, Eduardo (@elima-iii)
* Marques, Ricardo (@RicardoM17)
* Muntean, Doru (@chriton)
* Norrmann, Emilio (@enorrmann)
* Parvin, Darius E. (@DariusParvin)
* Smith, Alpha Q. (@alpha_github_id)
